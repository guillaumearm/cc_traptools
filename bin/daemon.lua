...
commands = {
  ...
  list = {
    ...
    call = function()
      for name in daemon.iter() do
        print(string.format("%s (%s, %s)", name, daemon.isEnabled(name) and "enabled" or "disabled",
  ...
  add = {
    ...
    args = {{"name", "The name of the daemon."}, {"path", "The path to the file."}},
...
local function usage()
  ...
  print("Use '" .. programName .. " help <command>' to get more information on a specific command.")
end
